      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className="min-h-screen">
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-zendots'>developerbyed</h1>
          ...
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium md:text-6xl">Ivan Horyn</h2>
            <h3 className="text-2xl py-2 md:text-3xl">React Developer</h3>
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint, atque!</p>
          </div>
