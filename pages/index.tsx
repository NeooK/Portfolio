...
import designe from '../public/designe.png';
      ...
      <main className='bg-white px-10'>
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium">Ivan Horyn</h2>
            <h3 className="text-2xl py-2">React Developer</h3>
            <p className="text-md py-5 leading-8 text-gray-800">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint, atque!</p>
          </div>
